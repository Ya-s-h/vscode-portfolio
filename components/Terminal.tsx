...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Yash!",
    'A backend-focused engineer building automation systems, APIs,',
    'data pipelines, and scalable backend services.',
  ],
  skills: () => [
    'Technical Skills:',
    '  Languages:  Python, JavaScript, SQL, Bash',
    '  Backend:    APIs, MongoDB, Elasticsearch, Redis, MySQL, Celery',
    '  Automation: Enterprise Automation, Chatbots, Workflow Design',
    '  AI/ML:      LangChain, MCP',
    '  Tools:      Git, Docker, Linux, VS Code, Postman',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. RICA — Flask health monitoring web app',
    '  2. Riktionary — Java multiplayer image guessing game',
    '  3. Twitch Watcher Bot — Discord bot for RLCS stream monitoring',
    '  4. Inventory Management System — MERN stack multi-user system',
    '',
  ...
  contact: () => [
    'Contact Information:',
    '  Website:  yashagg.com',
    '  GitHub:   github.com/Ya-s-h',
    '  LinkedIn: linkedin.com/in/yash-aggarwal-76a2851ba',
  ],
  resume: () => [
    'Resume available at /resume',
    'Download link on the resume page.',
  ],
  themes: () => [
    'Available themes:',
  ...
  ls: () => ['about/', 'projects/', 'resume/', 'skills/', 'contact/', 'README.md'],
